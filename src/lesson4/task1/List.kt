...
fun factorize(n: Int): List<Int> {
    var num = n
    var f = listOf<Int>()
    val d = Math.round(Math.sqrt(n.toDouble())).toInt()
    for (i in 2 .. d)
        while (num % i == 0) {
            f += i
            num /= i
 ...
 * Очень сложная
 *
 * Записать заданное натуральное число 1..999999 прописью по-руcски.
 * Например, 3755 = "три тысячи семьсот пятьдесят пять",
